...
export async function fetchMesEnfants(): Promise<EnfantResume[]> {
  const { data } =
    await http.get<ApiResponse<EnfantResume[]>>("/parent/enfants");
  return data.data;
}

/** Documents de la bibliothèque numérique visibles pour les écoles de mes enfants — lecture seule. */
export async function fetchMaBibliotheque(): Promise<
  DocumentBibliothequeLecture[]
> {
  const { data } = await http.get<ApiResponse<DocumentBibliothequeLecture[]>>(
    "/parent/bibliotheque",
  );
  return data.data;
}
...
export async function fetchEnfant(eleveId: number): Promise<EnfantDossier> {
  const { data } = await http.get<ApiResponse<EnfantDossier>>(
    `/parent/enfants/${eleveId}`,
  );
  return data.data;
}
...
export async function fetchFinanceEnfant(
  eleveId: number,
): Promise<FinanceEnfant | null> {
  const { data } = await http.get<ApiResponse<FinanceEnfant | null>>(
    `/parent/enfants/${eleveId}/finance`,
  );
  return data.data;
}
...
export async function fetchLeconsSemaineEnfant(
  eleveId: number,
): Promise<LeconsSemaine | []> {
  const { data } = await http.get<ApiResponse<LeconsSemaine | []>>(
    `/parent/enfants/${eleveId}/lecons-semaine`,
  );
  return data.data;
}
...
export async function fetchEmploiDuTempsEnfant(
  eleveId: number,
): Promise<CreneauEmploiDuTemps[]> {
  const { data } = await http.get<ApiResponse<CreneauEmploiDuTemps[]>>(
    `/parent/enfants/${eleveId}/emploi-du-temps`,
  );
  return data.data;
}

export const emploiDuTempsPdfEnfantUrl = (eleveId: number) =>
  `/parent/enfants/${eleveId}/emploi-du-temps/pdf`;
...
export async function fetchAbsencesEnfant(
  eleveId: number,
): Promise<AbsenceEnfant[]> {
  const { data } = await http.get<ApiResponse<AbsenceEnfant[]>>(
    `/parent/enfants/${eleveId}/absences`,
  );
  return data.data;
}
...
export async function fetchAssiduiteEnfant(
  eleveId: number,
): Promise<JourAssiduite[]> {
  const { data } = await http.get<ApiResponse<JourAssiduite[]>>(
    `/parent/enfants/${eleveId}/assiduite`,
  );
  return data.data;
}
...
export async function fetchJustificationsEnfant(
  eleveId: number,
): Promise<JustificationEnfant[]> {
  const { data } = await http.get<ApiResponse<JustificationEnfant[]>>(
    `/parent/enfants/${eleveId}/justifications`,
  );
  return data.data;
}
...
export async function soumettreJustification(
  ...
  const { data } = await http.post<ApiResponse<JustificationEnfant>>(
    `/parent/enfants/${eleveId}/justifications`,
    payload,
  );
  return data.data;
...
export async function fetchObservationsEnfant(
  eleveId: number,
): Promise<ObservationEnfant[]> {
  const { data } = await http.get<ApiResponse<ObservationEnfant[]>>(
    `/parent/enfants/${eleveId}/observations`,
  );
  return data.data;
}

export async function soumettreObservation(
  eleveId: number,
  contenu: string,
): Promise<ObservationEnfant> {
  const { data } = await http.post<ApiResponse<ObservationEnfant>>(
    `/parent/enfants/${eleveId}/observations`,
    { contenu },
  );
  return data.data;
...
export async function fetchVisitesInfirmerieEnfant(
  eleveId: number,
): Promise<VisiteInfirmerieEnfant[]> {
  const { data } = await http.get<ApiResponse<VisiteInfirmerieEnfant[]>>(
    `/parent/enfants/${eleveId}/visites-infirmerie`,
  );
  return data.data;
}
...
export async function fetchSanctionsEnfant(
  eleveId: number,
): Promise<DossierDisciplinaireEnfant> {
  const { data } = await http.get<ApiResponse<DossierDisciplinaireEnfant>>(
    `/parent/enfants/${eleveId}/sanctions`,
  );
  return data.data;
}
...
export async function fetchModificationEnAttente(
  eleveId: number,
): Promise<ModificationEnfantResume | null> {
  const { data } = await http.get<ApiResponse<ModificationEnfantResume | null>>(
...
export async function fetchHistoriqueModifications(
  ...
  const { data } = await http.get<ApiResponse<ModificationEnfantResume[]>>(
    `/parent/enfants/${eleveId}/modifications`,
  );
  return data.data;
}
...
export async function fetchMesPreinscriptions(): Promise<
  PreinscriptionResume[]
> {
  const { data } = await http.get<ApiResponse<PreinscriptionResume[]>>(
    "/parent/preinscriptions",
  );
  return data.data;
}

export async function soumettrePreinscription(
  payload: PreinscriptionPayload,
): Promise<PreinscriptionResume> {
  const { data } = await http.post<ApiResponse<PreinscriptionResume>>(
    "/parent/preinscriptions",
    payload,
  );
  return data.data;
...
export async function fetchMaPreinscription(
  id: number,
): Promise<PreinscriptionDetail> {
  const { data } = await http.get<ApiResponse<PreinscriptionDetail>>(
    `/parent/preinscriptions/${id}`,
  );
  return data.data;
}
...
export async function modifierPreinscription(
  ...
  const { data } = await http.put<ApiResponse<PreinscriptionResume>>(
    `/parent/preinscriptions/${id}`,
    payload,
  );
  return data.data;
...
export async function fetchEcolesDisponibles(): Promise<EcoleDisponible[]> {
  const { data } = await http.get<ApiResponse<EcoleDisponible[]>>(
    "/parent/ecoles-disponibles",
  );
  return data.data;
}

export async function fetchClassesDisponibles(
  schoolId: number,
): Promise<{ id: number; nom: string }[]> {
  const { data } = await http.get<ApiResponse<{ id: number; nom: string }[]>>(
    `/parent/ecoles/${schoolId}/classes`,
  );
  return data.data;
}
