...
import { ReglesValidationSeancePage } from '@/features/personnel/pages/ReglesValidationSeancePage'
...
export const router = createHashRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'regles-validation-seance', element: <ProtectedRoute superAdminOnly><ReglesValidationSeancePage /></ProtectedRoute> },
      ...
      { path: 'progression/calendrier', element: <ProtectedRoute permission="pedagogie.view"><CalendrierScolairePage /></ProtectedRoute> },
      ...
      { path: 'tarifs', element: <ProtectedRoute permission="finance.view" financesEcole><TarifsPage /></ProtectedRoute> },
      { path: 'depenses', element: <ProtectedRoute permission="finance.view" financesEcole><DepensesPage /></ProtectedRoute> },
