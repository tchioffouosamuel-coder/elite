...
import { GraduationCap, Megaphone, LogOut } from 'lucide-react'
...
const liens = [
  { to: '/eleve', fr: 'Mon dossier', en: 'My record', icon: GraduationCap, end: true },
  { to: '/eleve/annonces', fr: 'Annonces', en: 'Announcements', icon: Megaphone, end: true },
]
...
/**
 * Coquille du portail élève — même schéma que `ParentLayout`, avec un menu
 * plus court encore : un élève n'a qu'un seul dossier à consulter, pas une
 * liste d'enfants ni de démarches de préinscription à suivre.
 */
      ...
      <header className="flex-none border-b border-navy-100 bg-navy-800 text-cream-50">
        <div className="mx-auto flex min-w-0 max-w-5xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <span className="truncate font-display text-base font-bold tracking-tight">Espace élève / Student portal</span>
          </div>
