...
class ParentPreinscriptionController extends Controller
{
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'donnees_eleve.nationalite' => ['nullable', 'string', 'max:100'],
            'donnees_eleve.deplace_interne' => ['nullable', 'in:Oui,Non'],
            'donnees_eleve.bororo' => ['nullable', 'in:Oui,Non'],
            'donnees_eleve.baka' => ['nullable', 'in:Oui,Non'],
            'donnees_eleve.region_origine' => ['nullable', 'string', 'max:150'],
            'donnees_eleve.departement_origine' => ['nullable', 'string', 'max:150'],
            'donnees_eleve.redoublant' => ['nullable', 'boolean'],
            'donnees_eleve.ecole_precedente' => ['nullable', 'string', 'max:150'],
            'donnees_eleve.handicap' => ['nullable', 'in:Oui,Non'],
            'donnees_eleve.type_handicap' => ['nullable', 'string', 'max:255'],
