...
class RecuVersementGenerator
{
    ...
    {
        try {
            $data = "RC|{$versement->numero_recu}|{$versement->montant}|{$versement->date_versement->format('Y-m-d')}";
            ...
            return '<div class="sep"></div><div style="text-align:center">'
                . '<img src="data:image/png;base64,' . $imageData . '" style="width:20mm;height:20mm">'
                . '</div>';
        } catch (\Throwable $e) {
            return '';
        }
